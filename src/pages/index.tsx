  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HRManagementApplication, your ultimate destination for building a dynamic and efficient Human Resources infrastructure."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HRManagementApplication, your ultimate destination for building a dynamic and efficient Human Resources infrastructure.`}
            </Text>
            <Box
